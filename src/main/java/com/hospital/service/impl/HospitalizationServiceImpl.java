...
public class HospitalizationServiceImpl implements HospitalizationService {
    ...
    public String AddHospitalization(Hospitalization hospitalization) {
        int patientByBed = hospitalizationMapper.findPatientByBed(Integer.valueOf(hospitalization.getFloor()), Integer.valueOf(hospitalization.getDoor()), Integer.valueOf(hospitalization.getBed()));
        if(patientByBed>0){
            return CommonService.add_message_error_bed;
        }else{
