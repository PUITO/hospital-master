...
public class AppointmentController {
    ...
    @RequestMapping(value = "/admin/appmoney/{num}",method = RequestMethod.GET)
    @ResponseBody
    public JSONObject appmoney(@PathVariable int num){
        JSONObject json=new JSONObject();
        Double appMoney = appointmentService.getAppMoney(num);
        json.put("money",appMoney);
        return json;
    }
}
